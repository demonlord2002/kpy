...
from KPS import __version__
from KPS.bot import StreamBot
from KPS.bot.clients import cleanup_clients, initialize_clients
from KPS.server import web_server
from KPS.utils.commands import set_commands
from KPS.utils.database import db
from KPS.utils.handler import handle_flood_wait
from KPS.utils.keepalive import ping_server
from KPS.utils.logger import logger
from KPS.utils.messages import MSG_ADMIN_RESTART_DONE
from KPS.utils.rate_limiter import rate_limiter, request_executor
from KPS.utils.tokens import cleanup_expired_tokens
from KPS.vars import Var


PLUGIN_PATH = "KPS/bot/plugins/*.py"
VERSION = __version__
...
async def import_plugins():
    ...
    for file_path in plugins:
        try:
            ...
            import_path = f"KPS.bot.plugins.{plugin_name}"
